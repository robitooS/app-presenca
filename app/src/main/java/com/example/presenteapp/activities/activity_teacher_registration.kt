...
class activity_teacher_registration : AppCompatActivity() {
    ...
    // 1. Declarar o binding para a view e a instância do Firebase Auth.
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // 3. Configurar o listener de clique para o botão de registro.
    ...
    private fun registerTeacher() {
        // 4. Obter os dados dos campos de texto.
        ...
        // 6. Criar o usuário no Firebase Authentication.
        auth.createUserWithEmailAndPassword(email, password)
            .addOnCompleteListener(this) { task ->
                if (task.isSuccessful) {
                    // Se o usuário foi criado com sucesso no Firebase...
                    val firebaseUser = task.result?.user
                    val firebaseUid = firebaseUser?.uid

                    if (firebaseUid != null) {
                        // 7. ...agora, salve os dados no seu backend.
                    ...
                    // Se a criação do usuário no Firebase falhar...
    ...
    private fun saveTeacherToBackend(uid: String, name: String, email: String, course: String) {
        // 8. Criar o objeto para enviar à API.
        ...
        lifecycleScope.launch {
            try {
                ...
                if (response.isSuccessful) {
                    ...
                    // 10. Redirecionar para a tela de login.
                    ...
                    // Opcional: deletar o usuário do Firebase se o cadastro no backend falhar
